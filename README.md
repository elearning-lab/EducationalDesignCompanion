...
The prompt supports:
• Structuring new teaching materials  
• Critiquing existing content  
• Reducing extraneous cognitive load  
• Improving alignment with learning objectives  
• Encouraging evidence based design decisions  

It is written for educators who want direct, actionable guidance without long theory detours.
...
You can import the prompt into your own teaching assistant, custom GPT, or any system that accepts structured instructions. It guides you through:
1. Clarifying the learning goal  
2. Applying the multimedia principles  
